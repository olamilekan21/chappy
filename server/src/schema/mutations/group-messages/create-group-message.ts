import type { Reaction, messages } from "@prisma/client";
...
export interface ReturnCreateMessage extends messages {
  media: Media[];
  reactions: Reaction[];
}
const createGroupMessage: ResolverFn<Args, ReturnCreateMessage> = async (
  _,
  args,
  ctx
) => {
